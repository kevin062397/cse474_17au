...
extern void Port_C_Handler( void );
...
#pragma call_graph_root = "interrupt"
__weak void Port_C_Handler( void ) { while (1) {} }
#pragma call_graph_root = "interrupt"
__weak void UART0_Handler( void ) { while (1) {} }
#pragma call_graph_root = "interrupt"
__weak void UART1_Handler( void ) { while (1) {} }
#pragma call_graph_root = "interrupt"
__weak void Timer_0_Handler( void ) { while (1) {} }
#pragma call_graph_root = "interrupt"
__weak void Timer_1_Handler( void ) { while (1) {} }
